#'------------------------------------------------------------------------------------------
#'
#'	n u t s 4 D 4 7 S t a c k P r d . R
#'
#'	NUTS-4 | Division 47 | (turnover47s07 ~ femalePop + femaleWorkGrossWeek) | Stack Predict
#'
...
#	stopifnot("femaleWorkGrossWeek" %in% names(dfInput))
...
#-------------------------------------------------------------------------------------------
  	dfPred$turnover471s07 <- dfPred$depVar1*(49.33/100)
  	dfPred$turnover472s07 <- dfPred$depVar1*( 8.04/100)
  	dfPred$turnover473s07 <- dfPred$depVar1*( 4.98/100)
  	dfPred$turnover474s07 <- dfPred$depVar1*( 2.07/100)
  	dfPred$turnover475s07 <- dfPred$depVar1*( 9.18/100)
  	dfPred$turnover476s07 <- dfPred$depVar1*( 3.50/100)
  	dfPred$turnover477s07 <- dfPred$depVar1*(21.40/100)
  	dfPred$turnover478s07 <- dfPred$depVar1*( 0.02/100)
  	dfPred$turnover479s07 <- dfPred$depVar1*( 1.47/100)
...
#-------------------------------------------------------------------------------------------
	...
	dfPred$indVar1 		<- formatNumber(dfPred$indVar1,0)
	dfPred$indVar1Chg 	<- formatNumber(dfPred$indVar1Chg,0)
	dfPred$indVar1Pct 	<- formatNumber(dfPred$indVar1Pct,3)
	dfPred$indVar2 		<- formatNumber(dfPred$indVar2,2)
	dfPred$indVar2Chg	<- formatNumber(dfPred$indVar2Chg,2)
