#'------------------------------------------------------------------------------------------
#'
#'	n u t s 4 D 5 5 S t a c k A c t . R
#'
#'	NUTS-4 | Division 55 | (turnover55s07 ~ femaleWorkHourExOT + femalePop) | Stack Actual
#'
...
#   rows based on column setting e.g. depVars[!is.na(depVars$turnover55s07),].
#-------------------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------------------
	...
	dfTable$indVar1 <- formatNumber(dfTable$indVar1, 2)
