#'------------------------------------------------------------------------------------------
#'
#'	n u t s 4 D 4 7 F o o t f a l l P r d . R
#'
#'	NUTS-4 | Division 47 | (turnover47s07 ~ newborough2East + westborough2West) | Predict
#'
...
#-------------------------------------------------------------------------------------------
#   Get data and select desired date/time ranges
#-------------------------------------------------------------------------------------------
	...
	to 		 <- paste0(modelTo, "-12-31")
 	footfall <- subset(footfall, date >= "2007-01-01" & date <= to)
...
#-------------------------------------------------------------------------------------------
#   Re-scale and reformat for readability, then align independent variable names with screen
#	counterparts.
#-------------------------------------------------------------------------------------------
	indVars <- footfallSum
...
#-------------------------------------------------------------------------------------------
#   Re-scale and reformat for readability, then align dependent variable name with screen
#	counterpart.
#-------------------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------------------
#	Combine dependent and independent variables to suit model. Note, 2007 represents the
#  	first available and whole year of footfall data.
#-------------------------------------------------------------------------------------------
	dfModel <- subset(dfActual, year >= "2007" & year <= modelTo)
...
#-------------------------------------------------------------------------------------------
	...
	dfPred$indVar1 		<- formatNumber(dfPred$indVar1,3)
	dfPred$indVar1Chg 	<- formatNumber(dfPred$indVar1Chg,3)
	dfPred$indVar1Pct 	<- formatNumber(dfPred$indVar1Pct,3)
	dfPred$indVar2 		<- formatNumber(dfPred$indVar2,3)
	dfPred$indVar2Chg	<- formatNumber(dfPred$indVar2Chg,3)
