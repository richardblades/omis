#'------------------------------------------------------------------------------------------
#'
#'	n u t s 4 G 4 7 5 M o d e l P r d . R
#'
#'	NUTS-4 | Group 475 | (turnover475s07 ~ male16to64 + numBus475s07) | Predict
#'
#'  @param depVar1		:	("turnover475s07")
#'  @param depVar1Ttl	:	("turnover £m")
#'  @param factor1		:	("%","1"..."9")
#'  @param factor2		:	("%","1"..."9")
#'  @param geography	:	("nuts4")
#'  @param indVar1		: 	("male16to64")
#'  @param indVar2		: 	("numBus475s07")
...
#-------------------------------------------------------------------------------------------
	indVars <- indVars [, c("male16to64", "numBus475s07", "year" )]
		
#-------------------------------------------------------------------------------------------
#   Re-scale for readability and align independent variable names with screen counterparts.
#-------------------------------------------------------------------------------------------
#	indVars$male16to64 <- indVars$male16to64  / ???
#	indVars$numBus475s07 <- indVars$numBus475s07 / ???
    colnames(indVars)[which(names(indVars) == "male16to64" )] <- "indVar1"
    colnames(indVars)[which(names(indVars) == "numBus475s07")] <- "indVar2"
...
#   Select columns of interest
#-------------------------------------------------------------------------------------------
	depVars <- depVars[, c("turnover475s07", "year" )]
...
#-------------------------------------------------------------------------------------------
	depVars$turnover475s07 <- depVars$turnover475s07 / 1000000
    colnames(depVars)[which(names(depVars) == "turnover475s07")] <- "depVar1"
...
#	stopifnot("male16to64" %in% names(dfInput))
#	stopifnot("numBus475s07" %in% names(dfInput))
