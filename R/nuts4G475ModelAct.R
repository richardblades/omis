#'------------------------------------------------------------------------------------------
#'
#'	n u t s 4 G 4 7 5 M o d e l A c t . R
#'
#'	NUTS-4 | Group 475 | (turnover475s07 ~ male16to64 + numBus475s07) | Actual
#'
...
#   rows based on column setting e.g. depVars[!is.na(depVars$turnover475s07),].
#-------------------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------------------
	...
	dfTable$indVar2 <- formatNumber(dfTable$indVar2, 0)
